...
# yolo detect train data=VisDrone.yaml model=yolo11n-SSAM.yaml epochs=200 batch=16 imgsz=640 device=0 name='yolo11n-SSAM-VD200'
...
yolo detect train data=VisDrone.yaml model=yolo11n-CAAM-v2.yaml epochs=200 batch=16 imgsz=640 device=0 name='yolo11n-CAAM-v2-VD200-d0'
